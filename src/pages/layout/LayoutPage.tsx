      ...
      <div className="bg-gray-100 min-h-screen flex flex-col">
            ...
            <div className="flex-1 min-h-full flex">
              <div className="bg-gray-200 w-1/5 p-6">
                ...
                <ul>
                  <li className="mb-2">
                    <Link to="/about" className="text-gray-700 hover:underline">소개</Link>
                  </li>
                  <li className="mb-2">
                    <Link to="/services" className="text-gray-700 hover:underline">서비스</Link>
                  </li>
                  <li>
                    <Link to="/contact" className="text-gray-700 hover:underline">문의하기</Link>
                  </li>
                </ul>
              </div>
